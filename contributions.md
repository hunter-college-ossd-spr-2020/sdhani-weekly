...
| 13 | [PR to Next.js + MongoDB Example](https://github.com/vercel/next.js/pull/13028) | **Next.js** Contribution | Developed and contributed a fullstack example template for building Next.js projects with a MongoDB database with team TON. |
| S | [PR to CesiumJS + Webpack](https://github.com/CesiumGS/cesium-webpack-example/pull/21) | **CesiumJS** Contribution | Updated webpack's `copy-webpack-plugin` syntax implementation to include a pattern in version [6.0.3](https://www.npmjs.com/package/copy-webpack-plugin) as shown in their [docs](https://webpack.js.org/plugins/copy-webpack-plugin/). |
